                        ...
                        return (
                            <div key={index}>
                                <div className='flex flex-row lg:flex-col h-16 lg:h-20 items-center p-2 hover:text-purple-800 font-bold'>
                                    <Link href={settings.path} className={`flex outline outline-1 outline-slate-100 hover:outline-none lg:outline-none p-4 w-56 rounded-md mx-0 lg:mx-8 hover:bg-purple-300 ${active ? 'bg-purple-300 text-purple-800' : null}`}>
