...
const Delete: React.FC<propTypes> = ({ isVisible, onClose }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center' id="wrapper" onClick={handleClose}>
        <section className='w-[50%] lg:w-[80%] p-5 bg-white text-black flex flex-col justify-center items-center rounded-lg'>
            ...
            <button className='bg-[#EB1515] text-white p-3 rounded-md mt-3'>Delete Account</button>
        </section>
    </div>
  )
}
