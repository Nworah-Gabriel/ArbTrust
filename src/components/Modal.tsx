...
const Modal: React.FC<propTypes> = ({ isVisible, onClose }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center' id="wrapper" onClick={handleClose}>
      <div className='m-auto h-[90vh] w-[80%] text-black bg-[#EDEDED] rounded-lg'>
            <form action="#">
                <div className="flex flex-col-reverse lg:flex-row">
                    <section className='bg-white m-5 lg:mr-2 w-11/12 lg:w-1/2 p-4 rounded-md mt-5 h-fit'>
                    <h2 className="text-center mb-5 font-bold text-[14px]">ANSWER THE QUESTIONS BELOW</h2>
                        ...
                        <div className='grid leading-8 mt-3'>
                            <label htmlFor="q1" className="font-semibold">What is the name of your Tutor</label>
                            <div>
                        ...
                        <section className='bg-white rounded-md p-0'>
                            ...
                            {MintCertificate.map((brouse, index) => (
                                <div key={index} className=''>
                                    <div className='flex mx-6 mt-4 h-[40%]'>
